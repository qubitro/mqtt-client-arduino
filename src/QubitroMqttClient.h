#ifndef _QUBITRO_MQTT_CLIENT_H_
#define _QUBITRO_MQTT_CLIENT_H_
...
#define BAD_USER_NAME_OR_PASSWORD      4
#define NOT_AUTHORIZED                 5

class QubitroMqttClient : public Client {
public:
  QubitroMqttClient(Client& client);
  virtual ~QubitroMqttClient();
  ...
  void setDeviceIdToken(const char* username, const char* password);
  void setDeviceIdToken(const String& username, const String& password);
